...
namespace mxProject.Helpers.GrpcCore.Extensions.Internals
{
    ...
    internal sealed class AsyncConvertClientStreamWriter<TSource, TRequest> : IClientStreamWriter<TSource>
    {
        ...
        internal AsyncConvertClientStreamWriter(IClientStreamWriter<TRequest> streamWriter, Func<TSource, Task<TRequest>> converter)
        {
        ...
        private readonly Func<TSource, Task<TRequest>> m_Converter;
